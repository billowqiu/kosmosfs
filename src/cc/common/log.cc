...
MsgLogger::MsgLogger(const char* filename,MsgLogger::LogLevel logLevel): 
...
void MsgLogger::Init(const char* filename, MsgLogger::LogLevel logLevel)
{
    if (! logger)
    {
...
void MsgLogger::Init(const Properties& props, const char* propPrefix)
{
    Init(0);
