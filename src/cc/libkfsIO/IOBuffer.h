...
public:
    ...
    {
    public:
        StreamBuffer(IOBuffer& iobuf, int maxReadLength = std::numeric_limits<int>::max()):
            std::streambuf(),
...
class IOBuffer::OStream : public  IOBuffer,
    private IOBuffer::StreamBuffer,
    public  std::ostream
{
public:
    OStream(): IOBuffer(), IOBuffer::StreamBuffer(*this, 0), std::ostream(this)
    {

    }
};

class IOBuffer::IStream : private IOBuffer::StreamBuffer,
    public  std::istream
{
public:
    IStream(IOBuffer& iobuf, int maxReadLength = std::numeric_limits<int>::max()):
