...
public:
    ...
    bool isfull() const
    {
        return (count == NKEY);    //!< full
    }
    bool isdepleted() const
    {
        return (count < NFEWEST);    //!< underfull
    }
    int cpbit() const
    {
    ...
    */
    ...
    Node *peer() const
    {
        return next;    //!< return adjacent node
    }
    int children() const
    {
        return count;    //!< how many children
    }
...
public:
    ...
    void disableFidToPathname()
    {
        allowFidToPathConversion = false;
    }
    void enableFidToPathname()
    {
        allowFidToPathConversion = true;
    }
