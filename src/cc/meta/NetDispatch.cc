...
//
void NetDispatch::Start(int clientAcceptPort, int chunkServerAcceptPort)
{
...
///
void NetDispatch::Dispatch(MetaRequest *r)
{
    ...
    {
        MetaChangeChunkVersionInc *ccvi = static_cast<MetaChangeChunkVersionInc*> (r);
        if (ccvi->req != NULL)
        {
