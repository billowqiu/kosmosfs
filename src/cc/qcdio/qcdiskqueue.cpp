...
/* static */
const char* QCDiskQueue::ToString(QCDiskQueue::Error inErrorCode)
{
    switch (inErrorCode)
    {
    case kErrorNone:
    ...
    case kErrorEnqueue:
        return "enqueue";
    case kErrorOutOfBuffers:
        return "out of io buffers";
    case kErrorParameter:
        return "invalid parameter";
    case kErrorQueueStopped:
        return "queue stopped";
    case kErrorFileIdxOutOfRange:
        return "file index out of range";
    case kErrorBlockIdxOutOfRange:
        return "block index out of range";
    case kErrorBlockCountOutOfRange:
        return "block count out of range";
    case kErrorOutOfRequests:
        return "out of requests";
    case kErrorOpen:
        return "open";
    case kErrorClose:
        return "close";
    case kErrorHasPendingRequests:
        return "has pending requests";
    case kErrorSpaceAlloc:
        return "space allocation";
    default:
