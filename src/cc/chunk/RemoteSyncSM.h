...
class RemoteSyncSM : public KfsCallbackObj, public boost::enable_shared_from_this<RemoteSyncSM>
{
public:
...
RemoteSyncSMPtr FindServer(std::list<RemoteSyncSMPtr> &remoteSyncers, const ServerLocation &location, bool connect);
